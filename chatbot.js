// === ChatBot MyFreightLab propre avec historique local, prompts, reset, user_id et chat_id ===
document.addEventListener("DOMContentLoaded", () => {
  const webhookURL = "https://myfreightlab.app.n8n.cloud/webhook/0503eb30-8f11-4294-b879-f3823c3faa68";

  // On génère un chat_id unique pour chaque session
  let chat_id = generateChatId();
  let user_id = 123; // À remplacer plus tard par WordPress
  ...
  wrapper.innerHTML = `
    <style>
      ...
      * { font-family: 'Inter', sans-serif; }
      ...
      .floating-toggle { position: fixed; top: 50%; right: 0; transform: translateY(-50%); background-color: #0077c8; color: white; padding: 10px; border-radius: 8px 0 0 8px; cursor: pointer; font-size: 20px; z-index: 10000; }
    </style>
  ...
  resetBtn.addEventListener("click", () => {
    ...
    chat.innerHTML = "";
    chat_id = generateChatId(); // Nouveau chat_id sur reset
