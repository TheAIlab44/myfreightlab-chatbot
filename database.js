<!-- Initialisation Supabase (tout en haut) -->
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // ————— Fonction loadUserFiles() corrigée —————
  ...
  dropZone.addEventListener("drop", async e => {
    ...
    for (const f of e.dataTransfer.files) {
      ...
      // 2) insert métadonnées dans files_metadata
      ...
      // 3) ajouter localement dans l’UI
      files.push({
        id:       storageKey,
        name:     f.name,
        folderId: null,
